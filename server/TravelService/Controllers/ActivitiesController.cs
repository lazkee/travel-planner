...
public class ActivitiesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll(int planId)
    {
        ...
        var result = await _activityService.GetForPlanAsync(userId.Value, planId);
    ...
    public async Task<IActionResult> GetById(int planId, int id)
    {
        ...
        var result = await _activityService.GetByIdAsync(userId.Value, planId, id);
        return result.IsSuccess ? Ok(result.Value) : MapError(result.Error!);
    }

    [HttpPost]
    public async Task<IActionResult> Create(int planId, [FromBody] ActivityRequestDto request)
    {
        ...
        var result = await _activityService.CreateAsync(userId.Value, planId, request);
    ...
    public async Task<IActionResult> Update(int planId, int id, [FromBody] ActivityRequestDto request)
    {
        ...
        var result = await _activityService.UpdateAsync(userId.Value, planId, id, request);
        return result.IsSuccess ? Ok(result.Value) : MapError(result.Error!);
    }
    ...
    public async Task<IActionResult> Delete(int planId, int id)
    {
        ...
        var result = await _activityService.DeleteAsync(userId.Value, planId, id);
